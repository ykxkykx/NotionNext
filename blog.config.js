const { MUSIC_PLAYER_AUDIO_LIST } = require('./config/music')
...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'matery', // 主题， 支持 ['next','hexo', 'matery',"fukasawa','medium','example'] @see https://preview.tangly1024.com
  ...
  CONTACT_EMAIL: 'ykxkykx@foxmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/ykxkykx', // 你的github个人主页
  ...
  WIDGET_PET_LINK: 'https://unpkg.com/live2d-widget-model-miku@1.0.5/assets/miku.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_METING_ID: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8022276247', // 对应歌单的 id
